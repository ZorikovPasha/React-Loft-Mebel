...
const ProductTabs: React.FC = () => {
  ...
  const renderChosenTabContent = () => {
    switch (activeTab) {
      case 0:
        return <FeaturesTab features={tabsContents.features.items} />
      case 1:
        return <Reviews reviews={tabsContents.reviews.items} />
      case 2:
        return <Delivery deliveryMethods={tabsContents.delivery.items} />
    }
  }
    ...
    <section className='product-tabs'>
      <div className='container'>
        <div className='product-tabs__inner'>
          ...
          <div className='product-tabs__content'>{renderChosenTabContent()}</div>
        </div>
      </div>
    </section>
  )
