        ...
        <div className="footer__inner">
              ...
              <div className="footer__box">
                {footerLists &&
                  footerLists.map((list: string[]) => (
                    <ul className="footer__list" key={list[0]}>
                      {list.map((listItem) => (
                        <li className="footer__list-item" key={listItem}>
                          <Link to="/catalog" className="footer__list-link">
                            {listItem}
                          </Link>
                        </li>
                      ))}
          ...
          <div className="footer__bottom bottom-footer">
            <div className="bottom-footer__left">
              <Link to="/catalog" className="bottom-footer__text bottom-footer__text--promo">Акция</Link>
              <Link to="/catalog" className="bottom-footer__text">Новинки</Link>
            </div>
            <div className="bottom-footer__contacts">
              ...
              <a className="bottom-footer__mail" href="mailto:mebel_loft_anapa@mail.ru">
