        ...
        <div className="container">
          <div className="header__mid header__mid--taller">
            ...
            <nav className="header__nav">
              <ul className="header__list">
                <li className="header__list-item">
                  <a className="header__list-link" href="main.html">
                    Главная
                  </a>
                </li>
                <li className="header__list-item">
                  <a className="header__list-link" href="about.html">
                    О нас
                  </a>
                </li>
                <li className="header__list-item">
                  <a className="header__list-link" href="contacts.html">
                    Контакты
                  </a>
                </li>
              </ul>
            ...
            <form className="header__form" action="">
              <input className="header__input header__input--spec" type="text" placeholder="Поиск" />
          ...
          <div className="header__bottom header__bottom--toremove">
            <div className="header__categories categories">
              <ul className="categories__list">
                <li className="categories__item categories__item--promo">
                  ...
                  <a className="categories__link" href="catalog.html">
                    Акция
                  </a>
                </li>
                ...
                <li className="categories__item">
                  ...
                  <ul className="sub-list">
                    ...
                    <li className="sub-list__item">
                      <a className="sub-list__link" href="catalog.html">
                        Бытовыя техника
                      </a>
                    </li>
                  </ul>
                ...
                <div className="aside__box">
                  <form className="aside__form" action="">
                    ...
                    <div className="aside__filter filter">
                      ...
                      <input className="filter__range" type="text" name="my_range" value=""
                      data-type="double"
                      data-min="0"
                      data-max="120000"
                      data-from="2000"
                    ...
                    <div className="aside__filter filter">
                      ...
                      <div className="filter__colors colors">
                        <label className="colors__item">
                          <input className="colors__checkbox-real" type="checkbox" />
                          <span className="colors__checkbox-fake" data-color="#E94848"></span>
                        </label>
                        <label className="colors__item">
                          <input className="colors__checkbox-real" type="checkbox" />
                          <span className="colors__checkbox-fake" data-color="#43BF57"></span>
                        </label>
                        <label className="colors__item">
                          <input className="colors__checkbox-real" type="checkbox" />
                          <span className="colors__checkbox-fake " data-color="#E4E4E4"></span>
                        </label>
                        <label className="colors__item">
                          <input className="colors__checkbox-real" type="checkbox" />
                          <span className="colors__checkbox-fake" data-color="#3E3E3E"></span>
                        </label>
                        <label className="colors__item">
                          <input className="colors__checkbox-real" type="checkbox" />
                          <span className="colors__checkbox-fake" data-color="#675A5A"></span>
                        </label>
                        <label className="colors__item">
                          <input className="colors__checkbox-real" type="checkbox" />
                          <span className="colors__checkbox-fake" data-color="#864F4F"></span>
                        </label>
                      </div>
                    </div>
                    ...
                    <div className="aside__filter brands-filter">
                      ...
                      <label className="brands-filter__label">
                        <input className="brands-filter__checkbox-real" type="checkbox" />
                    ...
                    <a className="aside__link" href="#">Показать еще</a>
                    <button className="aside__btn" type="submit">Подобрать</button>
                  </form>
                </div>
              </aside>
              <div className="catalog__body">
                <div className="catalog__controls controls">
                  <button className="controls__toggle-aside">Фильтр</button>
                  <button className="controls__sort">
                    Сортировать
                    <ul className="sort-list">
                      <li className="sort-list__item">по убыванию цены</li>
                      <li className="sort-list__item">по возрастанию цены</li>
                      <li className="sort-list__item">по популярности</li>
                    </ul>
                  </button>
                </div>
