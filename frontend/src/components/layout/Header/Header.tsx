...
export const Header = ({ isMobMenuOpen, setMobMenuOpen, search, setSearch }: IHeaderProps) => {
  const items = [
    { name: 'Home', link: ROUTES.Home },
    { name: 'About us', link: ROUTES.About },
    { name: 'Contacts', link: ROUTES.Contacts }
  ]
        ...
        <div className='header__bottom'>
          <div className='header__categories categories'>
            <ul className='categories__list'>
              <li className='categories__item'>
                ...
                <ul className='header__sub-list'>
                  {subLists.current[0]?.map(({ link, text }) => (
                    ...
                    >
                      <Link href={`/catalog?room=kitchen&type=${link}`}>
                        <a className='sub-list__link'>{text}</a>
                      </Link>
                    </li>
                  ))}
                </ul>
                ...
                <ul className='header__sub-list'>
                  {subLists.current[1]?.map(({ link, text }) => (
                    <li
                      ...
                      className='sub-list__item'
                    >
                      <Link href={`/catalog?room=bedroom&type=${link}`}>
                        <a className='sub-list__link'>{text}</a>
                      </Link>
                    </li>
                  ))}
                ...
                <ul className='header__sub-list'>
                  {subLists.current[2]?.map(({ link, text }) => (
                    <li
                      ...
                      className='sub-list__item'
                    >
                      <Link href={`/catalog?room=living&type=${link}`}>
                        <a className='sub-list__link'>{text}</a>
                      </Link>
                    </li>
                  ))}
                ...
                <ul className='header__sub-list'>
                  {subLists.current[3]?.map(({ link, text }) => (
                    <li
                      ...
                      className='sub-list__item'
                    >
                      <Link href={`/catalog?room=hall&type=${link}`}>
                        <a className='sub-list__link'>{text}</a>
                      </Link>
                    </li>
                  ))}
                ...
                <ul className='header__sub-list'>
                  {subLists.current[4]?.map(({ link, text }) => (
                    <li
                      ...
                      className='sub-list__item'
                    >
                      <Link href={`/catalog?room=office&type=${link}`}>
                        <a className='sub-list__link'>{text}</a>
                      </Link>
                    </li>
                  ))}
              ...
              <li className='categories__item'>
                <Link href='/catalog?room=children'>
                  <a className='categories__item-a'>
                    <svg
                      width='23'
                      height='22'
                ...
                <ul className='header__sub-list header__sub-list--rightside'>
                  {subLists.current[5]?.map(({ link, text }) => (
                    <li
                      ...
                      className='sub-list__item'
                    >
                      <Link href={`/catalog?room=children&type=${link}`}>
                        <a className='sub-list__link'>{text}</a>
                      </Link>
                    </li>
                  ))}
